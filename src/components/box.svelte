<script>
    export let repo = "https://www.github.com";
    export let bgImg = "";
</script>

<box style="background-image: url({bgImg});">
    <h2>
        <slot name="name">
